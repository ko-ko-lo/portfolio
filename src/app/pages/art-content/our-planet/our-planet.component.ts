...
export class OurPlanetComponent {
  ...
  text: string[] = [
    'In reconnecting with nature, we also reconnect with ourselves. Nature is more than just a backdrop to our lives - it is a source of comfort, peace, and renewal. From the vast oceans that are our shared home to the forests that shelter countless species, nature gives us life in so many ways. The forests, with their soil that filters water and their importance in maintaining balance in the climate, are a reminder of how deeply intertwined we are with the natural world.',
    ...
    'Together, we have the power to protect and preserve this beautiful world - not just for ourselves, but for all living beings. ',
  ];
}
